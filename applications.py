...
def get_weather(city: str):
    ...
    """
    try:
        api_key="52927c373a7972d82dbf3748814bdc64"
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="e4cf1fc2bfb84cacadae30d7c8b31c0a"
...
def find_local_events(city: str):
    ...
    try:
        api_key="23f169a5d6e41e50dba4db00ed1abe7b4374d906ad93bb3898f87054284bc9c4"
